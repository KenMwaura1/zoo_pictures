...
class TestImage(TestCase):
    def setUp(self):
        self.location = Location(name='Umoja')
    ...
    def test_search_image_by_location(self):
        self.image_test.save_image()
        found_images = self.image_test.filter_by_location(location='Umoja')
        self.assertTrue(len(found_images) == 1)

    def test_search_image_by_category(self):
        self.image_test.save_image()
        found_img = self.image_test.search_by_category(category=self.category)
